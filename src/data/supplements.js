...
export const supplements = [
      ...
      // ... (the full remaining ~76 nodes with all their rich data, studies, gorkipedia, etc. exactly as in the original file)
    ];
...
export const categories = [ ... full categories array ... ];

export const organMeta = { ... full organMeta object ... };
